...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulationB_kir", _hoc_modulationB,
 "modulationA_kir", _hoc_modulationA,
 "rates_kir", _hoc_rates,
 0, 0
};
#define modulationB modulationB_kir
#define modulationA modulationA_kir
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gk = gbar * m * modulationA ( _threadargs_ ) * modulationB ( _threadargs_ ) ;
   ik = gk * ( v - ek ) ;
   }
 _current += ik;
