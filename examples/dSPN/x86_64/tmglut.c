...
#define failRateA _p[22]
#define failRateB _p[23]
...
#define modulationB_AMPA modulationB_AMPA_tmGlut
#define modulationA_AMPA modulationA_AMPA_tmGlut
#define modulationB_NMDA modulationB_NMDA_tmGlut
#define modulationA_NMDA modulationA_NMDA_tmGlut
