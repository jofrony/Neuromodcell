...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "efun_cal12", _hoc_efun,
 "ghk_cal12", _hoc_ghk,
 "modulationB_cal12", _hoc_modulationB,
 "modulationA_cal12", _hoc_modulationA,
 "rates_cal12", _hoc_rates,
 0, 0
};
#define efun efun_cal12
#define ghk ghk_cal12
#define modulationB modulationB_cal12
#define modulationA modulationA_cal12
 extern double efun( _threadargsprotocomma_ double );
 extern double ghk( _threadargsprotocomma_ double , double , double );
 extern double modulationB( _threadargsproto_ );
 extern double modulationA( _threadargsproto_ );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12 /home/jofrony/Documents/Repositories/Neuromodulation/examples/dSPN/x86_64/cal12.mod\n");
...
double modulationA ( _threadargsproto_ ) {
...
static void _hoc_modulationA(void) {
  ...
  _thread = _extcall_thread;
  _nt = nrn_threads;
 _r =  modulationA ( _p, _ppvar, _thread, _nt );
 hoc_retpushx(_r);
}
 
double modulationB ( _threadargsproto_ ) {
...
static void _hoc_modulationB(void) {
  ...
  _thread = _extcall_thread;
  _nt = nrn_threads;
 _r =  modulationB ( _p, _ppvar, _thread, _nt );
 hoc_retpushx(_r);
}
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ical = pbar * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cali , calo ) * modulationA ( _threadargs_ ) * modulationB ( _threadargs_ ) ;
   }
 _current += ical;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/Neuromodulation/examples/dSPN/mechanisms-dspn/cal12.mod";
static const char* nmodl_file_text = 
