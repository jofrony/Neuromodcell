...
extern Memb_func* memb_func;
 ...
 "efun_can", _hoc_efun,
 "ghk_can", _hoc_ghk,
 "modulationB_can", _hoc_modulationB,
 "modulationA_can", _hoc_modulationA,
 "rates_can", _hoc_rates,
 0, 0
};
#define efun efun_can
#define ghk ghk_can
#define modulationB modulationB_can
#define modulationA modulationA_can
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pbar * m * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cai , cao ) * modulationA ( _threadargs_ ) * modulationB ( _threadargs_ ) ;
   }
 _current += ica;
