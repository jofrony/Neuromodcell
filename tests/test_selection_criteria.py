...
def test_frequency_change():
    ...
    criteria ={ "selection" : {"mean" : 5, "std" : 1, "threshold":1}, "parameters" : { "tstart":0,"tstop": 1000, 'dt' : 100}}
...
def test_membrane_amplitude_increase():
    ...
    criteria = { "selection" : {"mean" : 10, "std" : 1, "threshold":1}, "parameters" : {'start_base' : 0, 'stop_base': 0.2, 'start_measure' : 0.4, 'stop_measure' : 0.8,'dt':0.1}}
...
def test_membrane_amplitude_increase_percentage():
    ...
    criteria = { "selection" : {"mean" : 200, "std" : 1, "threshold":1}, "parameters" : {'start_base' : 0, 'stop_base': 0.2, 'start_measure' : 0.4, 'stop_measure' : 0.8,'dt':0.1}}
...
def test_membrane_amplitude_decrease_percentage():
    ...
    criteria = { "selection" : {"mean" : 50, "std" : 1, "threshold":1}, "parameters" : {'start_base' : 0, 'stop_base': 0.2, 'start_measure' : 0.4, 'stop_measure' : 0.8,'dt':0.1}}
